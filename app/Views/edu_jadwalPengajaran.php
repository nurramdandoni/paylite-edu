          ...
          const requestOptions = {
                  ...
                  body: JSON.stringify(postJadwalPelajaran), // Mengubah data menjadi bentuk JSON
                    ...
                    for(item=0; item<jCount.length;item++){
                      ...
                      console.log("jam : ", hari.Senin.jam_group.data[jCount[item].jam_mulai].data.length);
                      ...
                      if(isFirstIteration){
                        tempCondition = `<td rowspan="`+hari[jCount[item].nama_hari].count+`">
                          ...
                          if(isFirstIteration){
                            tempCondition2 = `<td rowspan="`+hari[jCount[item].nama_hari].jam_group.data["07:01"].count+`">
