                  ...
                  body: JSON.stringify(postSiswa), // Mengubah data menjadi bentuk JSON
                    ...
                    for(item of data.data){
                      ...
                      <td class="align-middle">
                        <a style="cursor:pointer;" target="_blank" href="`+'<?= base_url(); ?>absensiMataAjar-tc/'+item.tahun_ajaran.tahun_ajaran_id+'/'+item.kelas.kelas_id+'/'+item.kurikulum.kurikulum_id+'/'+item.guru.guru_id+`" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Unduh
                        </a>
                      </td>
                    </tr>
