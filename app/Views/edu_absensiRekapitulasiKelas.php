                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">`+item.jadwal_pelajaran_id+`</h6>
                          </div>
                        </div>
                      </td>
                        <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">`+item.guru_id+`</h6>
                          </div>
                      <td>
                      </td>
                      <td class="align-middle">
                        <a style="cursor:pointer;" target="_blank" href="`+'<?= base_url(); ?>absensiMataAjar-tc/'+item.tahun_ajaran_id+'/'+item.data_kelas_id+'/'+item.kurikulum_id+`" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Unduh
                        </a>
                      </td>
                    </tr>
