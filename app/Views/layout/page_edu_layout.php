...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a id="mataAjar" class="nav-link" href="<?= base_url(); ?>mataAjar">
            ...
            <span class="nav-link-text ms-1">Mata Ajar</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a id="dataPesertaDidik" class="nav-link  " href="<?= base_url(); ?>dataPesertaDidik">
            ...
            <span class="nav-link-text ms-1">Data Peserta Didik</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a id="krs" class="nav-link  " href="<?= base_url(); ?>krs">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>credit-card</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a id="jadwalPengajaran" class="nav-link  " href="<?= base_url(); ?>jadwalPengajaran">
            ...
            <span class="nav-link-text ms-1">Jadwal Pengajaran</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a id="absensiReport" class="nav-link  " onclick="alert('Mohon Maaf Fitur ini sedang dalam Proses DevOps oleh Tim!');">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>customer-support</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <div class="sidenav-footer mx-3 ">
      ...
      <a class="btn bg-gradient-primary mt-3 w-100" href="<?= base_url(); ?>">Aktifkan!</a>
    </div>
  </aside>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li id="liDash" class="breadcrumb-item text-sm text-dark active" aria-current="page">Dashboard</li>
          </ol>
          <h6 id="liDash2" class="font-weight-bolder mb-0">Dashboard</h6>
        </nav>
